...
const SystemStatus: React.FC<SystemStatusProps> = ({ systemHealth }) => {
  ...
  const overallHealthy = Object.values(systemHealth.services).every(status => status);
    ...
    <Paper sx={{ p: 2, height: 400 }}>
      ...
      <List dense>
        <ListItem>
          ...
          />
          <Box ml={2}>
            {getStatusIcon(systemHealth.services.matching_engine)}
          </Box>
        </ListItem>
        ...
        <ListItem>
          ...
          />
          <Box ml={2}>
            {getStatusIcon(systemHealth.services.blockchain)}
          </Box>
        </ListItem>
